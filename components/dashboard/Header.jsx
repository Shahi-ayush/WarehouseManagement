...
// import { Bell, ChevronDown, HistoryIcon, LayoutGridIcon, Plus, Users2, Settings } from "lucide-react";
...
//     // ✅ FIX HERE
//     setNotifications(data.accounts || []);
...
//           <button className="p-1 hover:bg-slate-300 rounded-lg transition">
//             <Users2 className="w-4 h-4 text-slate-800" />
//           </button>

//           {/* ✅ Bell icon triggers notification panel */}
//           <button
...
//       onClick={() =>
//         router.push(`/dashboard/purchases/allcustomers/new/?phone=${encodeURIComponent(user.phone)}`)
//       }
//     >
...
//         {/* Layout Icon */}
//         <button className="p-1 hover:bg-slate-300 rounded-lg transition">
//           <LayoutGridIcon className="w-5 h-5 text-slate-800" />
//         </button>
//       </div>
//     </div>
//   );
